...
import { Target, LogIn, UserPlus } from 'lucide-react'; // Import icons for links
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-6 md:p-12 lg:p-16">
        ...
        <header className="w-full max-w-5xl mb-10 relative">
            {/* Login/Signup Links - Positioned top-right */}
           ...
           {/* Main Title and Description */}
            <div className="text-center mt-12 md:mt-0"> {/* Added margin-top for spacing on small screens */}
